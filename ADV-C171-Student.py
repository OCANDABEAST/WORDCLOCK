...
india_map = ImageTk.PhotoImage(Image.open("Flag_of_India.png"))
us_map = ImageTk.PhotoImage(Image.open("USA_FLAG.png"))
australia_map = ImageTk.PhotoImage(Image.open("Flag_of_Australia.png"))
japan_map = ImageTk.PhotoImage(Image.open("Japan_Flag.png"))
